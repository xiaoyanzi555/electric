...
<div style="float: left;margin-left: 40px">
    ...
    <select multiple style="width: 150px;height: 200px" id="all_consumer"></select>
</div>
...
<div style="float: left;">
    ...
    <select multiple style="height: 200px;width: 150px" id="check_consumer"></select>
</div>
<script type="text/javascript">
                    ...
                    $.ajax({
                        ...
                        success:function (result) {
                            ...
                            $.ajax({
                                type:'get',
                                url:'/users',
                                data:{task_id:task_id,pos_type:1},
                                headers:{"select":"uic"},
                                success:function (result) {
                                    if(result.code==200){
    ...
    function rightFunc() {
        $("#all_consumer option:selected").each(function () {
            $("#check_consumer")[0].appendChild($(this)[0]);
        })
    }
    function leftFunc() {
        $("#check_consumer option:selected").each(function () {
            $("#all_consumer")[0].appendChild($(this)[0]);
        })
    }
</script>