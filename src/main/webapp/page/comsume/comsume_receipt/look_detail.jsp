...
<body>
    <div style="background: #fff">
        <table>
            ...
            <tr>
                <td  align="right" width="150px"><strong>负责人审查意见</strong></td>
            ...
            <tr>
                <td  align="right" width="150px"><strong>下发人审查意见</strong></td>
                <td align="center" width="280px">{{comsumeTask.distribution_idea}}</td>
                <td><strong></strong></td>
                <td></td>
            </tr>
        </table>
        ...
        <p>工作间断延期记载</p>
        <textarea  rows="5" style="width: 100%">{{comsumeTask.overtime_record}}</textarea>
        <p>工作终结报告</p>
        <textarea  rows="5" style="width: 100%">{{comsumeTask.end_record}}</textarea>
        <div style="margin-top: 30px">
            <button onclick="fanhui()" style="padding: 5px 8px;float: right">返回</button>
        </div>
    </div>
    <style type="text/css">
