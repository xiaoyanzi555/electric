...
<table class="easyui-datagrid" id="defect_select_dg"
       ...
       onLoadSuccess:onLoadSuccess,striped:true,rownumbers:true,queryParams:{defect_type:2}">
    <thead>
    <tr>
        <th data-options="field:'task_code',align:'center'">任务编号</th>
        <th data-options="field:'task_stateString',align:'center'">任务状态</th>
        <th data-options="field:'work_documentsString',align:'center'">工作单据</th>
        <th data-options="field:'line_code',align:'center'">线路编号</th>
        <th data-options="field:'pole_code',align:'center'">杆塔编号</th>
        <th data-options="field:'defect_gradeString',align:'center'">缺陷级别</th>
        <th data-options="field:'defect_type_string',align:'center'">缺陷类型</th>
        <th data-options="field:'find_user_name',align:'center'">发现人</th>
        <th data-options="field:'find_time',align:'center'">发现时间</th>
        ...
        <th data-options="field:'defect_description',align:'center'">缺陷描述</th>
    </tr>
    </thead>
    <tbody>
    </tbody>
